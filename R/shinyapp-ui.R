...
dashboardUI <- function(request) {
  dashboardPage(skin="black", title = "BigcMetaExplorer",
                dashboardHeader(title = "",
                                # tags$li(class = "dropdown", tags$img(src=system.file("shinyapp","www", "baboon-outline.png", package="BigcMetaExplorer"))),
                                tags$li(class = "dropdown",
                                        tags$a(href="#",
                                               #target="_blank",
                                               style = "font-size: 20px;",
                                               "BIGC metagenomics data explorer")
                                ),
                                # tags$li(class = "dropdown", tags$a(href="https://ccb.jhu.edu", target="_blank", "CCB @ JHU")),
                                # tags$li(class = "dropdown", tags$a(href="http://twitter.com/share?url=http://ccb.jhu.edu/software/pavian&amp;text=Explore metagenomics data with #pavian ", target="_blank", tags$img(icon('twitter')))),
                                tags$li(class = "dropdown", tags$a(href="http://github.com/geekep/BigcMetaExplorer", target="_blank", tags$img(icon('github'))))
                ),
                dashboardSidebar(
                  ...
                  conditionalPanel(
                    ...
                    div(class="hide_when_sidebar_collapsed",
                    br(),
                    tags$p(class="sidebartext", style="padding-left: 10px;color: #b8c7ce; ", "Analyze metagenomics data in the 'Data Selection' tab."),
                    tags$p(class="sidebartext", style="padding-left: 10px;color: #b8c7ce; ", "View alignments and download genomes in the 'Alignment viewer' tab.")
                    )
                  ),
                  ...
                  div(class="hide_when_sidebar_collapsed", 
                  br(),
                  tags$p(class="sidebartext", style="padding-left: 10px;color: #b8c7ce; ",format(Sys.Date(), "@BIGC, %Y"))
                  )
                ),
                dashboardBody(
                  shinyjs::useShinyjs(),
                  tags$head(includeCSS(system.file("shinyapp", "style.css", package="BigcMetaExplorer"))),
                  ...
                  tabItems(
                    ...
                    tabItem(
                      ...
                      box(width=12,
                          HTML(
                            "<h2>
                            BigcMetaExplorer metagenomics data explorer
                            </h2>
                            <p>
                            This tool was developed by Zhen Xu in Yang's lab. This work was supported by YYYYYYYY [XXXXXXX].</p>")),
                      br(),
                      br(),
                      box(width=12,
...
navbarpageUI <- function(request) {
  navbarPage("BigcMetaExplorer", id="nav",
             tabPanel("Data Input",
                      dataInputModuleUI("datafile")
             ),
