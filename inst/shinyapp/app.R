...
if (!dir.exists(rappdirs::user_config_dir("BigcMetaExplorer", expand = FALSE))) {
  dir.create(rappdirs::user_config_dir("BigcMetaExplorer", expand = FALSE), recursive = TRUE)
}

### Option specifications
## Shiny options
# Specify the maximum web request size, which serves as a size limit for file uploads.
...
shiny::shinyApp(BigcMetaExplorer::dashboardUI, BigcMetaExplorer::pavianServer, enableBookmarking="server")
